...
The latest images include version [0.20.9](https://github.com/philippe44/SpotConnect/releases/tag/0.20.9).  
...
The changelog of the upstream project is available [here, on the upstream repo](https://github.com/philippe44/SpotConnect/blob/master/CHANGELOG).  

DATE|DESCRIPTION
:---|:---
2026-09-18|Bump to version [0.20.9](https://github.com/philippe44/SpotConnect/releases/tag/0.20.9)
2026-09-14|Bump to version [0.20.8](https://github.com/philippe44/SpotConnect/releases/tag/0.20.8)
2026-09-09|Bump to version [0.20.7](https://github.com/philippe44/SpotConnect/releases/tag/0.20.7)
2026-09-07|Bump to version [0.20.6](https://github.com/philippe44/SpotConnect/releases/tag/0.20.6)
2026-08-08|Bump to version [0.20.5](https://github.com/philippe44/SpotConnect/releases/tag/0.20.5)
2026-08-06|Bump to version [0.20.4](https://github.com/philippe44/SpotConnect/releases/tag/0.20.4)
2026-07-21|Bump to version [0.20.3](https://github.com/philippe44/SpotConnect/releases/tag/0.20.3)
2025-12-25|Bump to version [0.20.1](https://github.com/philippe44/SpotConnect/releases/tag/0.20.1)
